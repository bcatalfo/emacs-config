...
(setq user-full-name "Benjamin Catalfo"
      user-mail-address "bcatalfo@gmail.com")
...
;;
(setq doom-font (font-spec :family "Iosevka Fixed" :size 16 :weight 'normal)
    doom-variable-pitch-font (font-spec :family "Iosevka Fixed Slab" :weight 'normal :size 16))
...
;; Make the help popup happend quicker
(setq which-key-idle-delay 0.1)

;; Let me page through which-key
(setq which-key-use-C-h-commands t)

;; Want to format with black not pyright
